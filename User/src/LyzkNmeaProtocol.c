...
//        }
//        
//        /* Whether is RMC sentence */
//        if (*strMsg == '$' && *(strMsg + 3) == 'R' && *(strMsg + 4) == 'M'
//         && *(strMsg + 5) == 'C')
//        {
//            strMsg += 7;
...
//            }
//            
//            /* Speed over ground in knots, from 000.0 to 999.9*/
//            strMsg++;
//            i = 0;
//            while (*strMsg != ',')
//            {
...
//            *pdSpeed = atof (strTmp);
//            
//            /* Course over ground in degree, from 000.00 to 359.99 in north by east */
//            strMsg++;
//            i = 0;
//            while (*strMsg != ',')
//            {
...
//            }
//            
//            pstDate->m_iDay     = (strTmp [0] - '0') * 10 + (strTmp [1] - '0');
//            pstDate->m_iMonth   = (strTmp [2] - '0') * 10 + (strTmp [3] - '0');
//            pstDate->m_iYear    = (strTmp [4] - '0') * 10 + (strTmp [5] - '0') + 2000;
//            
//            /* Magnetic variation in degree, from 000.0 to 180.0 */
//            strMsg++;
//            i = 0;
//            while (*strMsg != ',')
//            {
...
//            }
//            strTmp [i] = 0;
//            *pdMagnVari = atof (strTmp);
//            
//            /* Magnetic variation indicator, East ('E', +) or West ('W', -) */
//            strMsg++;
//            i = 0;
//            while (*strMsg != ',')
//            {
